  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-primary text-primary bg-transparent hover:bg-primary/5 rounded-2xl",
        ...
        chip: "border border-primary text-primary bg-transparent hover:bg-primary/5 rounded-full text-xs font-medium",
        chipFilled: "bg-primary text-primary-foreground rounded-full text-xs font-medium",
        amber: "bg-accent text-accent-foreground hover:bg-accent/90 rounded-2xl",
        blue: "bg-secondary text-secondary-foreground hover:bg-secondary/90 rounded-2xl",
      },
      size: {
