...
from scripts.models import CivicIntent, ExtractedEntities, SourceItem, MapHighlight
from scripts.chatbot.date_utils import parse_temporal_intent, filter_events_by_date
...
def _retrieve_services(
    ...
    from scripts.chatbot.entities import detect_multi_categories
...
def _retrieve_events(message: str) -> tuple[list[SourceItem], str]:
    ...
    from scripts.predictive.mock_data import load_events
