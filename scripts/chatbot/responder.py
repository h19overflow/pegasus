...
from scripts.models import ChatRequest, ChatResponse, CivicIntent
from scripts.chatbot.intents import classify_intent
from scripts.chatbot.entities import extract_entities
from scripts.chatbot.followup import check_followup
from scripts.chatbot.retrieval import retrieve_context
...
async def handle_chat(request: ChatRequest) -> ChatResponse:
    ...
    from scripts.chatbot.context_memory import (
...
async def _handle_followup(
    ...
    from scripts.models import ConversationContext
...
async def _generate_answer(
    ...
    # Try Gemini first
    from scripts.chatbot.llm_provider import MockLLMProvider
...
def _build_template_answer(
    ...
    from scripts.models import SourceItem
...
def _answer_events(lower: str, sources: list) -> str:
    ...
    from scripts.models import SourceItem
    from scripts.chatbot.date_utils import parse_temporal_intent
...
async def _handle_traffic_followup(
    ...
    from scripts.chatbot.context_memory import save_context
    from scripts.models import ConversationContext
